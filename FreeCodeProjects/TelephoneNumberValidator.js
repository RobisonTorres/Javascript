...
function telephoneCheck(str) {
    ...
    /* This function return true if the passed string looks
    like a valid US phone number. */
...
/* Telephone Number Validator - Project specifications: 

Return true if the passed string looks like a valid US phone number.

The user may fill out the form field any way they choose as long as it has the format of a valid US number. The following are examples of 
...
For this challenge you will be presented with a string such as 800-692-7753 or 8oo-six427676;laskdjf. Your job is to validate or reject the US phone number
